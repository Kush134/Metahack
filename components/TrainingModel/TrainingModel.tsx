                    ...
                    <div className='z-30 w-[90%] h-[80vh] lg:w-[80%] lg:h-[80vh] bg-light rounded-md flex flex-col items-center justify-start overflow-x-hidden overflow-y-auto'>
                        ...
                        <div className='w-full h-full flex flex-col items-center justify-between py-10'>
                            <div className='w-full flex flex-col justify-between items-center'>
                                <p className='text-Dark text-4xl font-nunito font-semibold text-center px-5'>  Question {currentQuestionNumber + 1} : {TrainingModelQuestions?.questions[currentQuestionNumber]?.prompt} </p>

                                <div className='w-full flex flex-col items-center justify-center space-y-3 my-10'>
                                    {TrainingModelQuestions?.questions[currentQuestionNumber]?.options?.map((option: any) => {
                                        return (
                                            <button
                                                onClick={() => {
                            ...
                            <div className='w-full flex items-center justify-center space-x-3'>
                                {currentQuestionNumber == TrainingModelQuestions?.questions?.length - 1 ? (
                                    <button
                                        onClick={finishTest}
                                        type='button'
                                        title='submitBtn'
